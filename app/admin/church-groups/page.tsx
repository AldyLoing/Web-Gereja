...
export default function ChurchGroupAdminPage() {
  const [data, setData] = useState<ChurchGroup[]>([]);
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(`/api/church-groups?${params}`);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          <Link
            href={`/admin/church-groups/create`}
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex justify-end gap-2">
                            <Link
                              href={`/admin/church-groups/${item.id}/edit`}

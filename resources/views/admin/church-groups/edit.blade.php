...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
    <form action="{{ route('admin.church-groups.update', $churchGroup) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input 
                ...
                name="name" 
                id="name" 
                value="{{ old('name', $churchGroup->name) }}"
        ...
        <div class="mb-4">
            ...
            <textarea 
                ...
                rows="4"
                class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-blue-500 focus:ring-blue-500"
            >{{ old('description', $churchGroup->description) }}</textarea>
            @error('description')
                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            <label class="flex items-center">
                <input 
                    ...
                    name="is_active" 
                    value="1"
                    {{ old('is_active', $churchGroup->is_active) ? 'checked' : '' }}

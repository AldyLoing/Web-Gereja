...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.families.create') }}" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition">
            + Tambah Keluarga
        </a>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
        <form action="{{ route('admin.families.index') }}" method="GET" class="flex space-x-4">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari keluarga..." 
            ...
            <a href="{{ route('admin.families.index') }}" class="px-6 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">Reset</a>
        </form>
    </div>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $family->name }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">{{ $family->description ?? '-' }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('admin.families.show', $family) }}" class="text-green-600 hover:text-green-900 dark:text-green-400 mr-3">Detail</a>
                            <a href="{{ route('admin.families.edit', $family) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 mr-3">Edit</a>

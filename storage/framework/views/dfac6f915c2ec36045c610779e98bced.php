...
<div class="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav class="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
            <a href="<?php echo e(route('posts.index')); ?>" class="hover:text-church-green transition-colors duration-200">Beranda</a>
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
            </svg>
            <span class="text-gray-900 dark:text-white font-medium"><?php echo e(Str::limit($post->title, 50)); ?></span>
        </nav>
    </div>
</div>
...
<article class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="flex flex-wrap gap-2 mb-4">
        ...
        <a href="<?php echo e(route('posts.index', ['category' => $category->slug])); ?>" 
           class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-church-gold to-church-gold-dark text-white hover:scale-105 transition-transform duration-300">
    ...
    <!-- Meta Information -->
    <div class="flex items-center justify-between pb-6 mb-8 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center space-x-4 text-sm text-gray-600 dark:text-gray-400">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/>
                </svg>
                <span><?php echo e($post->user ? $post->user->name : 'Admin'); ?></span>
            </div>
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/>
                </svg>
                <span><?php echo e($post->published_at ? $post->published_at->format('d M Y') : $post->created_at->format('d M Y')); ?></span>
            </div>
        </div>
        
        <!-- Share Buttons -->
        <div class="flex items-center space-x-2">
            <span class="text-sm text-gray-600 dark:text-gray-400 mr-2">Bagikan:</span>
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(request()->url())); ?>" 
               target="_blank"
               class="p-2 text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors duration-200">
            ...
            <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($post->title)); ?>" 
               target="_blank"
               class="p-2 text-gray-600 hover:text-blue-400 dark:text-gray-400 dark:hover:text-blue-300 transition-colors duration-200">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://wa.me/?text=<?php echo e(urlencode($post->title . ' - ' . request()->url())); ?>" 
               target="_blank"
               class="p-2 text-gray-600 hover:text-green-600 dark:text-gray-400 dark:hover:text-green-400 transition-colors duration-200">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mb-10 rounded-2xl overflow-hidden shadow-2xl">
        <img src="<?php echo e(asset('storage/' . $post->cover)); ?>" 
    ...
    <div class="prose prose-lg dark:prose-invert prose-headings:text-gray-900 dark:prose-headings:text-white prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-a:text-church-green prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 dark:prose-strong:text-white prose-img:rounded-xl prose-img:shadow-lg max-w-none mb-12">
    ...
    <div class="pt-8 border-t border-gray-200 dark:border-gray-700">
        <a href="<?php echo e(route('posts.index')); ?>" 
           class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-church-green to-church-green-dark text-white rounded-full hover:scale-105 transition-transform duration-300 shadow-lg">
...
<div class="bg-gray-50 dark:bg-gray-900 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Warta Terkait</h2>
            <p class="text-gray-600 dark:text-gray-400">Baca juga warta lainnya yang mungkin Anda minati</p>
        </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Orders\Project\Web Gereja\resources\views/posts/show.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('page-title', 'Edit Postingan'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <?php if($post->cover): ?>
                    <div class="mb-3">
                        <img src="<?php echo e(asset('storage/' . $post->cover)); ?>" alt="Current cover" class="w-48 h-32 object-cover rounded">
                    </div>
                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="categories[]" value="<?php echo e($category->id); ?>" 
                                <?php echo e(in_array($category->id, old('categories', $post->categories->pluck('id')->toArray())) ? 'checked' : ''); ?>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="15"
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-gray-200"><?php echo e(old('content', $post->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', $post->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Orders\Project\Web Gereja\resources\views/admin/posts/edit.blade.php ENDPATH**/ ?>